...
ha = current.day
today = date.today()
#SHOWROB2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://m.facebook.com/profile.php?id=ITS.DEVIL.08')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio SHOWROB_OK.mp3")
                print('\033[1;92m[SHOWROB-OK] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mSHOWROB","\x1b[1;92mSHOWROB","\x1b[1;93mSHOWROB","\x1b[1;94mSHOWROB","\x1b[1;95mSHOWROB","\x1b[1;96mSHOWROB","\x1b[1;97mSHOWROB","\x1b[1;91mSHOWROB","\x1b[1;92mSHOWROB","\x1b[1;93mSHOWROB","\x1b[1;94mSHOWROB","\x1b[1;95mSHOWROB","\x1b[1;96mSHOWROB"])
